...
class OutcomeCashierExport implements FromView, ShouldAutoSize, WithColumnFormatting
{
    use Exportable;
    ...
    public function view(): View
    {
        ...
        $datas = OutcomeCashier::with('detail.coa')->whereBetween('date', [$from, $to]);
        ...
        return view('outcome-cashier.excel', [
            'datas' => $datas,
            'from' => $from,
            'to' => $to,
