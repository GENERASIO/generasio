...
{
    public static $pageTitle = 'Contact';
    // public static $pageDescription = 'Contact Description';
    // public static $modelName = 'App\Models\Contact';
    public static $permissionName = 'contact';
    public static $folderPath = 'contact';
    public static $routePath = 'contacts';
    ...
    public function index(Request $req)
    {
        if ($req->ajax()) {
            $user = Auth::user();
            return Datatables::of(Contact::query())->addIndexColumn()->make(true);
        }
    ...
    public function create()
    {
        ...
        return view(self::$folderPath.'.create', compact('contact', 'pageTitle', 'routePath'));
    }
    ...
    public function store(Request $request)
    {
        ...
        // logs
        ActivityLog::create([
            'name' => Auth::user()->name . ' menambahkan ' . self::$pageTitle . ' ' . $contact->id,
    ...
    public function show($id)
    {
        ...
        return view(self::$folderPath.'.show', compact('contact', 'pageTitle', 'routePath'));
    }
    ...
    public function edit($id)
    {
        ...
        return view(self::$folderPath.'.edit', compact('contact', 'pageTitle', 'routePath'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        // logs
        ActivityLog::create([
            'name' => Auth::user()->name . ' mengubah ' . self::$pageTitle . ' ' . $contact->id,
            'icon' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    public function destroy(Request $req, $id)
    {
        ...
        // logs
        ActivityLog::create([
            'name' => Auth::user()->name . ' menghapus ' . self::$pageTitle . ' ' . $contact->id,
            'icon' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
