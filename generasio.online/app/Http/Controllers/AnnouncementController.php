...
class AnnouncementController extends Controller
{
    ...
    public function create()
    {
        ...
        return view(self::$folderPath.'.create', compact('announcement', 'pageTitle',  'routePath', 'target'));
    }
    ...
    public function show($id)
    {
        ...
        return view(self::$folderPath.'.show', compact('announcement', 'pageTitle',  'routePath'));
    }
    ...
    public function edit($id)
    {
        ...
        return view(self::$folderPath.'.edit', compact('announcement', 'pageTitle',  'routePath', 'target'));
    }
