...
{
    public static $pageTitle = 'Menu Website';
    public static $permissionName = 'menu';
    public static $folderPath = 'menu';
    public static $routePath = 'menus';
    ...
    public function index(Request $req)
    {
        if ($req->ajax()) {
            $user = Auth::user();
            return DataTables::of(Menu::query())->addIndexColumn()->make(true);
        }
    ...
    public function create()
    {
        ...
        return view(self::$folderPath.'.create', compact('menu', 'pageTitle', 'routePath'));
    }
    ...
    public function show($id)
    {
        ...
        return view(self::$folderPath.'.show', compact('menu', 'pageTitle', 'routePath'));
    }
    ...
    public function edit($id)
    {
        ...
        return view(self::$folderPath.'.edit', compact('menu', 'pageTitle', 'routePath'));
    }
