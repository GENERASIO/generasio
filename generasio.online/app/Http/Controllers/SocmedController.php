...
{
    public static $pageTitle = 'Socmed';
    // public static $pageDescription = 'Socmed Description';
    // public static $modelName = 'App\Models\Socmed';
    public static $permissionName = 'socmed';
    public static $folderPath = 'socmed';
    public static $routePath = 'socmeds';
    ...
    public function index(Request $req)
    {
        if ($req->ajax()) {
            $user = Auth::user();
            return Datatables::of(Socmed::query())->addIndexColumn()->make(true);
        }
    ...
    public function create()
    {
        ...
        return view(self::$folderPath.'.create', compact('socmed', 'pageTitle', 'routePath'));
    }
    ...
    public function store(Request $request)
    {
        ...
        // logs
        ActivityLog::create([
            'name' => Auth::user()->name . ' menambahkan ' . self::$pageTitle . ' ' . $socmed->id,
    ...
    public function show($id)
    {
        ...
        return view(self::$folderPath.'.show', compact('socmed', 'pageTitle', 'routePath'));
    }
    ...
    public function edit($id)
    {
        ...
        return view(self::$folderPath.'.edit', compact('socmed', 'pageTitle', 'routePath'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        // logs
        ActivityLog::create([
            'name' => Auth::user()->name . ' mengubah ' . self::$pageTitle . ' ' . $socmed->id,
            'icon' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    public function destroy(Request $req, $id)
    {
        ...
        // logs
        ActivityLog::create([
            'name' => Auth::user()->name . ' menghapus ' . self::$pageTitle . ' ' . $socmed->id,
            'icon' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
