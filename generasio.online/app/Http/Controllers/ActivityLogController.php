...
class ActivityLogController extends Controller
{
    ...
    public function index(Request $req)
    {
        if ($req->ajax()) {
            ...
            if(Auth::user()->can('role-create')){
                ...
                return Datatables::of(ActivityLog::with('user')->where('created_by', Auth::user()->id)->get())->addIndexColumn()->make(true);
            }
        }
    ...
    public function create()
    {
        ...
        return view(self::$folderPath.'.create', compact('activityLog', 'pageTitle',  'routePath'));
    }
    ...
    {
        $activityLog = ActivityLog::with('user')->where('id', $id)->first();
        ...
        return view(self::$folderPath.'.show', compact('activityLog', 'pageTitle',  'routePath'));
    }
    ...
    public function edit($id)
    {
        ...
        return view(self::$folderPath.'.edit', compact('activityLog', 'pageTitle',  'routePath'));
    }
