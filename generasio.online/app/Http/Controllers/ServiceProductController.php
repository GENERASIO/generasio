...
{
    public static $pageTitle = 'Service Product';
    // public static $pageDescription = 'Service Product Description';
    // public static $modelName = 'App\Models\ServiceProduct';
    public static $permissionName = 'service-product';
    public static $folderPath = 'service-product';
    public static $routePath = 'service-products';
    ...
    public function index(Request $req)
    {
        if ($req->ajax()) {
            ...
            $data = ServiceProduct::select('service_products.name', 'service_products.created_at', 'service_products.id', 'service_products.status', 'service_products.price', 'service_catalogs.name as game')->join('service_catalogs', 'service_catalogs.slug', 'service_products.slug', 'service_products.price')->where('service_catalogs.status', 'available')->get();
    ...
    public function create()
    {
        ...
        return view(self::$folderPath.'.create', compact('serviceProduct', 'pageTitle', 'routePath'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $serviceProduct = ServiceProduct::create($req);
        ...
        // logs
        ActivityLog::create([
            'name' => Auth::user()->name . ' menambahkan ' . self::$pageTitle . ' ' . $serviceProduct->id,
    ...
    public function show($id)
    {
        ...
        return view(self::$folderPath.'.show', compact('serviceProduct', 'pageTitle', 'routePath'));
    }
    ...
    public function edit($id)
    {
        ...
        return view(self::$folderPath.'.edit', compact('serviceProduct', 'pageTitle', 'routePath'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        // logs
        ActivityLog::create([
            'name' => Auth::user()->name . ' mengubah ' . self::$pageTitle . ' ' . $serviceProduct->id,
            'icon' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    public function destroy(Request $req, $id)
    {
        ...
        // logs
        ActivityLog::create([
            'name' => Auth::user()->name . ' menghapus ' . self::$pageTitle . ' ' . $serviceProduct->id,
            'icon' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
