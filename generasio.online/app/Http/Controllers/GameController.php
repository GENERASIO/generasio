...
{
    public static $pageTitle = 'Game';
    // public static $pageDescription = 'Game Description';
    // public static $modelName = 'App\Models\Game';
    public static $permissionName = 'game';
    public static $folderPath = 'game';
    public static $routePath = 'games';
    ...
    public function index(Request $req)
    {
        if ($req->ajax()) {
            $user = Auth::user();
            return Datatables::of(Game::query())->addIndexColumn()->make(true);
        }
    ...
    public function create()
    {
        ...
        return view(self::$folderPath.'.create', compact('game', 'pageTitle', 'routePath'));
    }
    ...
    public function store(Request $request)
    {
        ...
        // logs
        ActivityLog::create([
            'name' => Auth::user()->name . ' menambahkan ' . self::$pageTitle . ' ' . $game->id,
    ...
    public function show($id)
    {
        ...
        return view(self::$folderPath.'.show', compact('game', 'pageTitle', 'routePath'));
    }
    ...
    public function edit($id)
    {
        ...
        return view(self::$folderPath.'.edit', compact('game', 'pageTitle', 'routePath'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        // logs
        ActivityLog::create([
            'name' => Auth::user()->name . ' mengubah ' . self::$pageTitle . ' ' . $game->id,
            'icon' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    public function destroy(Request $req, $id)
    {
        ...
        // logs
        ActivityLog::create([
            'name' => Auth::user()->name . ' menghapus ' . self::$pageTitle . ' ' . $game->id,
            'icon' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
