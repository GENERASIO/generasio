...
class RoleController extends Controller
{
    ...
    public function index(Request $req)
    {
        ...
        return view('role.index', compact('pageTitle',  'permissionName', 'routePath', 'data', 'minimize'));
    }
    ...
    public function create()
    {
        ...
        return view(self::$folderPath.'.create', compact('role', 'pageTitle',  'routePath', 'permissions'));
    }
    ...
    public function store(Request $request)
    {
        ...
        // logs
        ActivityLog::create([
            'name' => Auth::user()->name . ' menambahkan ' . self::$pageTitle . ' ' . $role->name,
    ...
    public function show($id)
    {
        ...
        return view(self::$folderPath.'.show', compact('role', 'pageTitle',  'routePath', 'rolePermissions'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('role.edit', compact('role', 'permissions', 'rolePermissions', 'pageTitle',  'routePath'));
    }
    ...
    public function update(Request $request, Role $role)
    {
        ...
        // logs
        ActivityLog::create([
            'name' => Auth::user()->name . ' mengubah ' . self::$pageTitle . ' ' . $role->name,
            'icon' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    public function destroy(Request $req, $id)
    {
        ...
        // logs
        ActivityLog::create([
            'name' => Auth::user()->name . ' menghapus ' . self::$pageTitle . ' ' . $role->name,
            'icon' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
