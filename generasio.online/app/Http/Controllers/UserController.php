...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // logs
        ActivityLog::create([
            'name' => Auth::user()->name . ' menambahkan ' . self::$pageTitle . ' ' . $user->name,
    ...
    public function show($slug, Request $req)
    {
        ...
        $id = $user->id;
        $usernameSlug = $user->username;

        return view(self::$folderPath.'.show', compact('user', 'usernameSlug', 'pageTitle',  'routePath', 'role', 'completion', 'id', 'activityLog', 'transactions'));
    }
    ...
    public function update(Request $request, User $user)
    {
        ...
        $role = Role::where('name', $req['roles'])->first();
        $req['role_id'] = $role->id;
        ...
        // logs
        ActivityLog::create([
            'name' => Auth::user()->name . ' mengubah ' . self::$pageTitle . ' ' . $user->name,
            'icon' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    public function destroy(Request $req, $id)
    {
        ...
        // logs
        ActivityLog::create([
            'name' => Auth::user()->name . ' menghapus ' . self::$pageTitle . ' ' . $user->name,
            'icon' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
