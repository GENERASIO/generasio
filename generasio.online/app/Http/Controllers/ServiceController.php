...
class ServiceController extends Controller
{
    ...
    // public static $pageDescription = 'Service Description';
    // public static $modelName = 'App\Models\Service';
    public static $permissionName = 'service';
    public static $folderPath = 'service';
    public static $routePath = 'services';
    ...
    public function create()
    {
        ...
        return view(self::$folderPath.'.create', compact('service', 'pageTitle', 'routePath'));
    }
    ...
    public function store(Request $request)
    {
        ...
        // logs
        ActivityLog::create([
            'name' => Auth::user()->name . ' menambahkan ' . self::$pageTitle . ' ' . $service->id,
    ...
    public function show($id)
    {
        ...
        return view(self::$folderPath.'.show', compact('service', 'pageTitle', 'routePath'));
    }
    ...
    public function edit($id)
    {
        ...
        return view(self::$folderPath.'.edit', compact('service', 'pageTitle', 'routePath'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        // logs
        ActivityLog::create([
            'name' => Auth::user()->name . ' mengubah ' . self::$pageTitle . ' ' . $service->id,
            'icon' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    public function destroy(Request $req, $id)
    {
        ...
        // logs
        ActivityLog::create([
            'name' => Auth::user()->name . ' menghapus ' . self::$pageTitle . ' ' . $service->id,
            'icon' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
