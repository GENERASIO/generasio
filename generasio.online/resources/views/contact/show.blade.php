                ...
                <div class="card">
                    ...
                    <div class="card-body table-responsive">
                        <table class="table table-bordered table-hover w-100">
                            ...
                            <tr>
                                <td>Dibuat oleh</td>
                                <td><a href="{{ url('application/users') . '/' .  $contact->user->username}}" target="_blank">{{ $contact->user->name }}</a> at {{ $contact->created_at }}</td>
                            </tr>
                            <tr>
                                <td>Diubah oleh</td>
                                <td><a href="{{ url('application/users') . '/' .  $contact->userUpdate->username}}" target="_blank">{{ $contact->userUpdate->name }}</a> at {{ $contact->updated_at }}</td>
                            </tr>
                        </table>
                    </div>
                </div>
