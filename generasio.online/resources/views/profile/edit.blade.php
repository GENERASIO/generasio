            ...
            <form id="kt_account_profile_details_form" class="form" action="{{ route($routePath.'.update', $user->id) }}" role="form" enctype="multipart/form-data" method="POST">
                ...
                <div class="card-body border-top p-9">
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            <!--begin::Image input-->
                            <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('{{ asset('demo34/dist') }}/assets/media/svg/avatars/blank.svg')">
                                ...
                                @else
                                <div class="image-input-wrapper w-125px h-125px" style="background-image: url('{{ asset('demo34/dist') }}/assets/media/svg/avatars/blank.svg')"></div>
                                @endif
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9">
                    <a href="{{ route($routePath.'.index') }}" class="btn btn-light btn-active-light-primary me-2">Kembali</a>
