                    ...
                    <div class="card-body table-responsive">
                        <table class="table table-bordered table-hover w-100">
                            ...
                            <tr>
                                ...
                                <td>{{ $socmed->created_by }}</td>
                            </tr>
                            <tr>
                                <td width="20%">Updated By</td>
                                <td>{{ $socmed->updated_by }}</td>
                            </tr>

                            <tr>
                                <td>Dibuat oleh</td>
                                <td><a href="{{ url('application/users') . '/' .  $socmed->user->username}}" target="_blank">{{ $socmed->user->name }}</a> at {{ $socmed->created_at }}</td>
                            </tr>
                            <tr>
                                <td>Diubah oleh</td>
                                <td><a href="{{ url('application/users') . '/' .  $socmed->userUpdate->username}}" target="_blank">{{ $socmed->userUpdate->name }}</a> at {{ $socmed->updated_at }}</td>
                            </tr>
                        </table>
                    </div>
                </div>
