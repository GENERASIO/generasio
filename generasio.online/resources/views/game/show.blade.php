                ...
                <div class="card">
                    ...
                    <div class="card-body table-responsive">
                        <table class="table table-bordered table-hover w-100">
                            ...
                            <tr>
                                <td>Dibuat oleh</td>
                                <td><a href="{{ url('application/users') . '/' .  $game->user->username}}" target="_blank">{{ $game->user->name }}</a> at {{ $game->created_at }}</td>
                            </tr>
                            <tr>
                                <td>Diubah oleh</td>
                                <td><a href="{{ url('application/users') . '/' .  $game->userUpdate->username}}" target="_blank">{{ $game->userUpdate->name }}</a> at {{ $game->updated_at }}</td>
                            </tr>
                        </table>
                    </div>
                </div>
