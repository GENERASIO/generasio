                ...
                <div class="card">
                    ...
                    <div class="card-body table-responsive">
                        <table class="table table-bordered table-hover w-100">
                            ...
                            <tr>
                                <td>Dibuat oleh</td>
                                <td><a href="{{ url('application/users') . '/' .  $service->user->username}}" target="_blank">{{ $service->user->name }}</a> at {{ $service->created_at }}</td>
                            </tr>
                            <tr>
                                <td>Diubah oleh</td>
                                <td><a href="{{ url('application/users') . '/' .  $service->userUpdate->username}}" target="_blank">{{ $service->userUpdate->name }}</a> at {{ $service->updated_at }}</td>
                            </tr>
                        </table>
                    </div>
                </div>
