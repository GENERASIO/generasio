                ...
                <div class="card">
                    ...
                    <div class="card-body table-responsive">
                        <table class="table table-bordered table-hover w-100">
                            ...
                            <tr>
                                <td width="20%">Page</td>
                                <td>{{ $pageSetting->page }}</td>
                            </tr>
                            <tr>
                                <td width="20%">Type</td>
                                <td>{{ $pageSetting->type }}</td>
                            </tr>
                            <tr>
                                <td width="20%">Name</td>
                                <td>{{ $pageSetting->name }}</td>
                            </tr>
                            <tr>
                                <td width="20%">Status</td>
                                <td>{{ $pageSetting->status }}</td>
                            </tr>

                            <tr>
                                <td>Created By</td>
                                <td><a href="{{ url('application/users') . '/' .  $pageSetting->user->username}}" target="_blank">{{ $pageSetting->user->name }}</a> at {{ $pageSetting->created_at }}</td>
                            </tr>
                            <tr>
                                <td>Updated By</td>
                                <td><a href="{{ url('application/users') . '/' .  $pageSetting->userUpdate->username}}" target="_blank">{{ $pageSetting->userUpdate->name }}</a> at {{ $pageSetting->updated_at }}</td>
                            </tr>
                        </table>
                    </div>
                </div>
