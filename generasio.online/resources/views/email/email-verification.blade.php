...
<head>
    ...
    <meta charset="utf-8" />
    <meta name="description" content="Sistem Pakar - Depresi Check, We care your shipments, we care your business growth" />
    <meta name="keywords" content="trd, trd.co.id, Triadhipa, Logistics, Sistem Pakar, Zamasco" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="article" />
    <meta property="og:title" content="Sistem Pakar - Depresi Check" />
    <meta property="og:url" content="https://sistem-pakar.dynastina.com" />
    <meta property="og:site_name" content="Sistem Pakar" />
    <link rel="canonical" href="https://sistem-pakar.dynastina.com" />
                                    ...
                                    <td align="center" valign="center" style="text-align:center; padding-bottom: 10px">
                                        ...
                                        <div style="text-align:center; margin:0 15px 34px 15px">
                                            ...
                                            <div style="margin-bottom: 10px">
                                                <a href="https://sistem-pakar.dynastina.com" rel="noopener" target="_blank">
                                                    <img alt="Sistem Pakar Logo" src="{{ $message->embed(public_path() . '/assets/img/logo.png') }}" style="height: 70px" />
                                                </a>
                                            </div>
                                            <!--end:Logo-->
                                            <!--begin:Media-->
                                            <div style="margin-bottom: 15px">
                                                <img alt="Forgot Password Icon" src="{{ $message->embed(public_path() . '/assets/img/logo.png') }}" />
                                            </div>
                                            <!--end:Media-->
                                            <!--begin:Text-->
