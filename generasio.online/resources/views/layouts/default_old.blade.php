...
<head>
    <title>@yield('title', $pageTitle ?? 'DefastNet') | Solusi Internet Anda</title>

    {{-- basic meta --}}
    <meta charset="utf-8" />
    <meta name="description" content="@yield('description', $pageDescription ?? 'DeFast.Net menghadirkan paket internet super cepat di rumah yang termurah dikelasnya. Sangat cocok untuk anda yang sedang WorkFromHome atau menghadirkan sekolah online untuk anak. DeFast.Net juga memberikan akses cepat ke berbagai provider hiburan seperti Netflix dan provider gaming sehingga anda sekeluarga akan merasa nyaman saat StayAtHome.')" />
    <meta name="keywords" content="@yield('keywords', $pageKeywords ?? 'defast, defastnet, condifa, digitech, solusindo, internet, provider')" />
    ...
    <meta property="og:title" content="DefastNet" />
    <meta property="og:url" content="https://www.defast.net.id/" />
    <meta property="og:site_name" content="DeFast Net | Solusi Internet Anda" />

    {{-- Open Graph --}}
    <meta property="og:locale" content="id_ID" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="@yield('title', $pageTitle ?? 'DefastNet') | Solusi Internet Anda" />
    <meta property="og:description" content="@yield('description', $pageDescription ?? 'DeFast.Net menghadirkan paket internet super cepat di rumah yang termurah dikelasnya. Sangat cocok untuk anda yang sedang WorkFromHome atau menghadirkan sekolah online untuk anak. DeFast.Net juga memberikan akses cepat ke berbagai provider hiburan seperti Netflix dan provider gaming sehingga anda sekeluarga akan merasa nyaman saat StayAtHome.')">
    <meta property="og:url" content="@yield('url', $pageUrl ?? 'https://www.defast.net.id/')" />
    <meta property="og:site_name" content="DefastNet" />
    <meta property="og:image" content="{{ asset('') }}assets/media/defast/favicon2.ico" />
    <meta property="og:image:secure_url" content="{{ asset('') }}assets/media/defast/favicon2.ico" />
    <meta property="og:image:type" content="image/ico" />
    <meta property="og:image:width" content="256" />
    <meta property="og:image:height" content="256" />

    {{-- Twitter --}}
    <meta name="twitter:title" content="@yield('title', $pageTitle ?? 'DefastNet') | Solusi Internet Anda">
    <meta name="twitter:description" content="@yield('description', $pageDescription ?? 'DeFast.Net menghadirkan paket internet super cepat di rumah yang termurah dikelasnya. Sangat cocok untuk anda yang sedang WorkFromHome atau menghadirkan sekolah online untuk anak. DeFast.Net juga memberikan akses cepat ke berbagai provider hiburan seperti Netflix dan provider gaming sehingga anda sekeluarga akan merasa nyaman saat StayAtHome.')">
    <meta name="twitter:image" content="{{ asset('') }}assets/media/defast/favicon2.ico">
    <meta name="twitter:image:src" content="{{ asset('') }}assets/media/defast/favicon2.ico">

    {{-- Image Icon --}}
    <!--begin::Fonts(mandatory for all pages)-->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Inter:300,400,500,600,700" />
    <link rel="canonical" href="https://www.defast.net.id/" />
    <link rel="shortcut icon" href="{{ asset('') }}assets/media/defast/favicon2.ico" />
    <!--end::Fonts-->
...
<body id="kt_app_body" data-kt-app-layout="light-sidebar" data-kt-app-header-fixed="true"
    ...
    data-kt-app-sidebar-minimize="@yield('minimize', $minimize ?? 'off')">
                ...
                <div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
                    ...
                    <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                        <a href="{{ url('application/dashboard') }}" class="d-lg-none">
                            <img alt="Logo App Mobile" src="{{ asset('assets/media/defast/favicon2.ico') }}"
                                class="h-30px" />
                        </a>
                    </div>
                    <!--end::Mobile logo-->
            ...
            <div id="kt_activities" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="activities"
                ...
                <div class="card shadow-none border-0 rounded-0 w-100">
                    ...
                    <div class="card-footer py-5 text-center" id="kt_activities_footer">
                        <a href="{{ url('application/activity-logs') }}" class="btn btn-bg-body text-primary">Liat
                            Semua Aktivitas
            ...
            <div id="kt_drawer_chat" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="chat"
                ...
                <div class="card w-100 rounded-0 border-0" id="kt_drawer_chat_messenger">
                    ...
                    <div class="card-body" id="kt_drawer_chat_messenger_body">
                        <!--begin::Messages-->
                        <div class="scroll-y me-n5 pe-5 announcement" data-kt-element="messages"
                ...
                <div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true"
                    ...
                    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
                        ...
                        <a href="{{ url('application/dashboard') }}">
                            <img alt="Logo App Brand" src="{{ asset('assets/media/defast/favicon2.ico') }}"
                                class="h-40px app-sidebar-logo-default" />
                            <img alt="Logo App Minimize" src="{{ asset('assets/media/defast/favicon2.ico') }}"
