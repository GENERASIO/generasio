...
@section('content')
<!--begin::Card-->
<div class="card rounded-3 w-md-550px mt-3">
    <!--begin::Card body-->
    <div class="card-body p-10 p-lg-20">
        ...
        <form method="POST" class="form" id="kt_login_singin_form" action="{{ route('login.post') }}">
            ...
            <div class="text-center mb-11">
                ...
                <!--end::Title-->
                <!--begin::Subtitle-->
                <div class="text-gray-500 fw-semibold fs-6">Internet Insight Management</div>
                <!--end::Subtitle=-->
            </div>
            ...
            <div class="alert alert-danger d-flex align-items-center p-5">
                ...
                <div class="d-flex flex-column">
                    ...
                    <!--end::Title-->
                    <!--begin::Content-->
                    <span>Pastikan anda telah terdaftar dan tidak salah dalam memasukan email maupun password. <br> {{ ($message == '1' ? '' : 'Password hint : ' . $message) }}</span>
                    <!--end::Content-->
                </div>
                <!--end::Wrapper-->
            </div>
            ...
            <div class="fv-row mb-8">
                <!--begin::Email-->
                <input class="form-control bg-transparent" type="email" name="email" autocomplete="off" placeholder="Masukan Email" required />
                <!--end::Email-->
            </div>
            <!--end::Input group=-->
            ...
            <!--end::Submit button-->
            <!--begin::Sign up-->
            <div class="text-gray-500 text-center fw-semibold fs-6">Kembali ke halaman utama?
                <a href="{{ url('') }}" class="link-primary">Klik Disini</a>
            </div>
            <!--end::Sign up-->
        </form>
        <!--end::Form-->
